...
public class PassengerRideDetailsResponseDTO {
    ...
    public PassengerRideDetailsResponseDTO() {
    }

    public PassengerRideDetailsResponseDTO(Long rideId, List<RideStopDTO> rideStops, double distanceKm, double totalPrice, String driverName, String driverLastName, String driverEmail, String driverPhoneNumber, Map<String, String> reportReasons, List<RideGradeDTO> rideGrades) {
        this.rideId = rideId;
